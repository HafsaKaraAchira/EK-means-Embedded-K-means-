...
int main(int argc, char **argv)
{
	...
	kmeans_by_chunk(source,dim, taille, N, atoi(argv[2]),centroid);
	...
	char solution_file_name[200]="generator/CM13,4M_2400MO_SEP0,2/real_centers.csv" ;

	// r8mat_write ("results/centers.csv",dim,k,centroid) ;
