...
(scripts/prog_script_cache) && (clear && gcc -g perf_stats/kmeans_perf.c -o perf_stats/kmeans_perf -lm -D _GNU_SOURCE)
./perf_stats/kmeans_perf generator/CM13,4M_2400MO_SEP0,2/points.csv 2 13421800 6710900 10
