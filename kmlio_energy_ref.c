...
(scripts/prog_script_reset) && (clear && gcc -g kmlio_energy_ref.c -o prog_energy_ref -lm -D _GNU_SOURCE) && (./prog_energy_ref generator/10D/13421800N/SEP-0.9/points.csv 10 13421800 6710900 10)
(scripts/prog_script_reset) && (clear && gcc -g kmlio.c -o prog_energy_ref -lm -D _GNU_SOURCE) && ((./prog_energy_ref generator/CM13,4M_2400MO_SEP0,2/points.csv 10 13421800 6710900 10) & (taskset -c 1 scripts/prog_script_launch))
...
/*
  ...
  Parameters:
	...
	Input, int N, the number of points.  The prog_energy_ref
